...
    public const int ERROR_PRINTER_DRIVER_DOWNLOAD_NEEDED = 0x00000BCB;
...
    public const int ERROR_DS_INVALID_ATTRIBUTE_SYNTAX = 0x0000200B;
...
    public const int ERROR_DS_PUBLIC_CONSTRAINT_VIOLATION = 0x0000202F;
```
...
    public const int ERROR_DS_SINGLE_VALUE_PUBLIC_CONSTRAINT = 0x00002081;
```
...
    public const int ERROR_DS_PUBLIC_CONSTRUCTED_ATT_MOD = 0x0000211B;
```
...
    public const int ERROR_DS_DRA_RECYCLED_TARGET = 0x000021BF;
