...
        [return: MarshalAs(UnmanagedType.Interface)]
        IEnumGUID RemoteEnumClassesOfCategories(int cImplemented, [In, MarshalAs(UnmanagedType.LPArray)] Guid[] rgcatidImpl, int cRequired, [In, MarshalAs(UnmanagedType.LPArray)] Guid[] rgcatidReq);
